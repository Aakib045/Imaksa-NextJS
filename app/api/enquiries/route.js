  ...
  try {
    ...
    try {
      ...
      await resend.emails.send({
        ...
        subject: `New Enquiry from ${name} — IMAKSA`,
        html: `
          <div style="font-family:Inter,sans-serif;max-width:600px;margin:0 auto;padding:32px;background:#F5EFE4;">
            <div style="background:#0D4F4A;padding:24px;text-align:center;margin-bottom:24px;">
              ...
              <p style="color:#C9A84C;font-size:11px;letter-spacing:3px;text-transform:uppercase;margin:4px 0 0;">New Property Enquiry</p>
            </div>
      ...
      await resend.emails.send({
        ...
        html: `
          <div style="font-family:Inter,sans-serif;max-width:600px;margin:0 auto;padding:32px;background:#F5EFE4;">
            ...
            <p style="color:#4A4A4A;line-height:1.8;margin-bottom:16px;">We have received your enquiry and one of our expert consultants will get back to you within 24 hours.</p>
