    ...
    <div style={{ fontFamily: 'var(--font-inter)' }}>
      ...
      <section style={{ padding: `clamp(48px,6vw,80px) clamp(16px,5vw,72px)`, background: '#FAFAF8' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          {blogs.length === 0 ? (
            <motion.div {...fadeUp}>
              <div style={{textAlign:'center', padding:'clamp(60px,8vw,100px) clamp(16px,5vw,72px)'}}>
                <p style={{fontSize:'clamp(8px,1.3vw,10px)', letterSpacing:5, textTransform:'uppercase', color:'#2E8B84', marginBottom:16}}>COMING SOON</p>
                <h2 style={{fontFamily:'Fraunces, serif', fontSize:'clamp(26px,4vw,48px)', fontWeight:300, color:'#0D4F4A', marginBottom:20}}>Dubai Real Estate Insights</h2>
                <p style={{fontSize:'clamp(13px,1.3vw,15px)', color:'#3A3A3A', lineHeight:1.85, maxWidth:600, margin:'0 auto 32px'}}>
                  We are preparing expert insights on Dubai real estate market trends, investment opportunities, buying guides, and market updates. Subscribe below to be the first to receive our articles.
                </p>
                <p style={{fontSize:'clamp(13px,1.3vw,15px)', color:'#3A3A3A', lineHeight:1.85, maxWidth:600, margin:'0 auto'}}>
                  IMAKSA Real Estate LLC offers expert guidance on buying, selling, and investing in Dubai properties across Palm Jumeirah, Downtown Dubai, Dubai Marina, Business Bay, and more premium locations.
                </p>
              </div>
            </motion.div>
          ) : (
